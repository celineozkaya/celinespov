...
import titre from '../assets/whatsup.svg'
    ...
    return (
        <>
            ...
            <div style={{display : "flex", flexDirection : "column", gap : "20px"}}>
                ...
                <div>
                    <iframe title="deezer-widget" src="https://widget.deezer.com/widget/auto/track/3266945721" width="100%" height="100%" allow="encrypted-media; clipboard-write"></iframe>
                </div>
